...
Modulating valve. Controls outlet pressure.
Equal percentage characteristic.
Fail-closed on loss of signal.
"""
...
class OutletValve:
    ...
    def update(self, dt: float, state):
        ...
        with state:
            state.outlet_valve_position_pct  = self.position_pct
            state.outlet_valve_commanded_pct = self.commanded_pct
